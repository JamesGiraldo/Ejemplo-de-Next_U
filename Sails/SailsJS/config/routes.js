...
module.exports.routes = {
 ...
 'GET /': 'PrincipalController.inicio',
  ...
  //  Ampliando funcionabilidad para el perfil de Admin

  'GET /admin/clientes': 'AdminController.listaClientes',
  ...
  'GET /admin/administradores': 'AdminController.listaAdministradores',
