...
COINMARKET_API_KEY = "c0cbebee-21f4-44cc-8d59-bcb993490e45" # Esta es la llave de la API que nos permite hacer peticiones a la direccion URL de la API
...
print(data)  # esto imprime toda la data o sea la información del servicio binance
